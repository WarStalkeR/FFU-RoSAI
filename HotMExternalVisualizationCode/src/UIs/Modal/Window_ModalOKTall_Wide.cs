...
{
    public class Window_ModalOKTall_Wide : Window_ModalBaseOK, IInputActionHandler
    {
        ...
        public override bool GetShouldDrawThisFrame_Subclass()
        {
            ...
            if ( data == null )
                return false;
            if ( data.Style != ModalPopupStyle.OkTallWide )
                return false;
            return true;
        }
        ...
        {
            public override float WidthForBodyText => 800f; //20px spare room
        }
