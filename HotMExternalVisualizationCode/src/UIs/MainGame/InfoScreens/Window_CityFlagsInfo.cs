...
{
    public class Window_CityFlagsInfo : ToggleableWindowController, IInputActionHandler
    {
        public static Window_CityFlagsInfo Instance;
        public override bool PutMeOnTheEscapeCloseStack => true;
		public Window_CityFlagsInfo()
        {
            Instance = this;
        ...
        private static readonly List<CityFlag> sortedFilteredFlags = List<CityFlag>.Create_WillNeverBeGCed( 800, "Window_CityFlagsInfo-sortedFilteredFlags" );
        ...
        public class tHeaderText : TextAbstractBase
        {
            ...
            {
                Buffer.AddLang( "CityFlags_Header" ).Space1x().AddFormat1( "Parenthetical", sortedFilteredFlags.Count );
            }
        }
        ...
        {   
            public customParent()
            {
                Window_CityFlagsInfo.CustomParentInstance = this;
            }
            ...
            private void OnUpdate_Content()
            {
                ...
                sortedFilteredFlags.Sort( delegate ( CityFlag left, CityFlag right )
                {
                ...
                foreach ( CityFlag flagGlobal in sortedFilteredFlags )
                {
