...
{
    public class Window_UnitStyleLowerLeftNovelTooltip : WindowControllerAbstractBase
    {
        private static Window_UnitStyleLowerLeftNovelTooltip _instance;
        public Window_UnitStyleLowerLeftNovelTooltip()
        {
            _instance = this;
        ...
        public class customParent : CustomUIAbstractBase, UnitStyleNovelTooltipHandler.USNStatManager
        {
            ...
            {
                handler.bun.UpdateWindowReferences( (ArcenUI_CustomUI)Element, "LowerLeftUnitStyleNovel", TooltipBundle.PositionStyle.LowerLeftCorner, true, 32750 );
            }
