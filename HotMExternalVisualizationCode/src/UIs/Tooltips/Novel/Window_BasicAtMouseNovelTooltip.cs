...
{
    public class Window_BasicAtMouseNovelTooltip : WindowControllerAbstractBase
    {
        private static Window_BasicAtMouseNovelTooltip _instance;
        public Window_BasicAtMouseNovelTooltip()
        {
            _instance = this;
        ...
        public class customParent : CustomUIAbstractBase
        {
            ...
            {
                handler.bun.UpdateWindowReferences( (ArcenUI_CustomUI)Element, "AtMouseBasicNovel", TooltipBundle.PositionStyle.AtMouseStandard, true, 32740 );
            }
        }
